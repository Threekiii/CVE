...
- 2024.06
  ...
  * CVE-2024-32030：UI for Apache Kafka 后台 jmx jndi 代码执行漏洞
...
- 2024.10
  ...
  * CVE-2024-31449：Redis Lua Script 溢出漏洞
  * CVE-2024-38819：Spring Framework 特定条件下目录遍历漏洞
  * CVE-2024-45216：Apache Solr 认证绕过漏洞
  * CVE-2024-47575：Fortinet FortiManager 身份认证绕过漏洞
  * CVE-2024-51567：CyberPanel upgrademysqlstatus 远程命令执行漏洞
## 0x02 声明
